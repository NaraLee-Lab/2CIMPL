...
This is a modified version of this original software suite developed for detection of chimeric or circular RNAs from LIGR-seq data (see citation below). Specifically, the `detect` file in /bin/ has been modified in a few ways, primarily for increased flexibility in parameters.
